...
// Right hand
#define HOME_MC MT(MOD_RCTL, KC_M)
#define HOME_MG MT(MOD_RGUI, KC_M)
#define HOME_COMM MT(MOD_RSFT, KC_COMM)
#define HOME_DOT MT(MOD_LALT, KC_DOT) // Using LALT for better compatibility.
#define HOME_SLHC MT(MOD_RCTL, KC_SLSH)
#define HOME_SLHG MT(MOD_RGUI, KC_SLSH)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 [MAC_BASE] = LAYOUT_ansi_82(
        ...
        KC_LSFT,            HOME_ZC,  HOME_X,   HOME_C,   HOME_VG,  KC_B,     KC_N,     HOME_MG,  HOME_COMM,HOME_DOT,HOME_SLHC, KC_RSFT,            KC_UP,
TD(TD_CTL_HYP),   KC_LOPTN, KC_LCMMD,                               KC_SPC,                                 KC_RCMMD,MO(MAC_FN),KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [MAC_FN] = LAYOUT_ansi_82(
        ...
        RGB_TOG,  RGB_MOD,  RGB_VAI,  RGB_HUI,  RGB_SAI,  _______,  RGB_SPI,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
        _______,  RGB_RMOD, RGB_VAD,  RGB_HUD,  RGB_SAD,  TG(GAME_BASE),RGB_SPD,_______,_______,  _______,  _______,  _______,            _______,            KC_END,
    ...
    [WIN_BASE] = LAYOUT_ansi_82(
        ...
        KC_TAB,   KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,    KC_LBRC,   KC_RBRC,  KC_BSLS,            KC_PGDN,
        MOD_ESC,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN, KC_QUOT,   KC_ENT,                       KC_HOME,
        KC_LSFT,            HOME_ZG,  HOME_X,   HOME_C,   HOME_VC,  KC_B,     KC_N,     HOME_MC,  HOME_COMM,HOME_DOT,HOME_SLHG, KC_RSFT,            KC_UP,
    ...
    [MOD1] = LAYOUT_ansi_82(
        ...
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
        _______,  _______,  _______,LSFT(KC_LBRC),LSFT(KC_RBRC),_______,_______,_______,_______,  _______,  _______,  _______,  _______,  _______,            _______,
        _______,  KC_LBRC,  KC_RBRC,LSFT(KC_9), LSFT(KC_0),_______, KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  _______,  _______,            _______,            _______,
    ...
    [GAME_BASE] = LAYOUT_ansi_82(
        ...
        KC_LCTL,  KC_LOPTN, KC_LCMMD,                               KC_SPC,                                 KC_RCMMD, MO(GAME_FN),KC_RCTL,KC_LEFT,  KC_DOWN,  KC_RGHT),

    [GAME_FN] = LAYOUT_ansi_82(
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
        _______,  _______,  _______,  _______,  _______,  TG(GAME_BASE),_______,_______,_______,  _______,  _______,  _______,            _______,            _______,
        _______,            _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,  _______,
        _______,  _______,  _______,                                _______,                                _______,  _______,  _______,  _______,  _______,  _______)
};
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [MOD1]     = {ENCODER_CCW_CW(KC_MS_WH_UP, KC_MS_WH_DOWN)},
